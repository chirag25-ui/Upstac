...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        return testRequestQueryService.findByDoctor(doctorUser);
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            User doctorUser = userLoggedInService.getLoggedInUser();
            return testRequestUpdateService.assignForConsultation(id,doctorUser);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            User doctorUser = userLoggedInService.getLoggedInUser();
            return testRequestUpdateService.updateConsultation(id,testResult,doctorUser);
